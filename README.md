...
![12.1](https://github.com/TeslenkoPavlo/TeslenkoPavlo-Implementation-of-a-simple-password-generation-algorithm-in-C/blob/main/PNG/12.1.png)
1. case 3: - вказує, що наступний блок коду буде виконаний, якщо значення змінної, яка перевіряється в конструкції switch, дорівнює 3.
2. std::cout << "До побачення!" << std::endl; - виводить текст "До побачення!" у консоль.
3. break; - вказує, що виконання конструкції switch потрібно зупинити на цьому етапі.
4. default: - вказує початок блоку коду, який буде виконаний, якщо жодна з умов case не виконається.
5. std::cout << "Виберіть наявний програму від 1 до 3" << std::endl; - виводить текст "Виберіть наявний програму від 1 до 3" у консоль.
6. break; - вказує, що виконання конструкції switch потрібно зупинити на цьому етапі.
